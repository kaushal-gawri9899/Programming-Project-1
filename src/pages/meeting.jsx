      ...
      <div className="current-view">
        <div className="nav">
          <div className="avatar-container">
            ...
            <div className="avatar-text">Job Matching Portal</div>
            ...
            <div className={classes.menuContainer}>
              {config.host && (
                <div className={classes.menu}>
                  <Tooltip title={muteVideo ? 'Disable-Video' : 'Enable-Video'}>
                    <i
                  ...
                  <Tooltip title={stateCtx.screen ? 'Disable-Screenshare' : 'Enable-Screenshare'}>
                    <i
