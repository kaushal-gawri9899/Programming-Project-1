  ...
  return (
    <Box flex="1" display="flex" flexDirection="column">
      ...
      >
        ...
        <FormControl>
          <InputLabel className={classes.menuLabel} htmlFor="resolution">Resolution</InputLabel>
          <Select className={classes.selectLabel}
        ...
        <FormControl>
          <InputLabel className={classes.menuLabel} htmlFor="codec">Video Codec</InputLabel>
          <Select className={classes.selectLabel}
        ...
        <FormControl>
          <InputLabel className={classes.menuLabel} htmlFor="camera">Camera</InputLabel>
          <Select className={classes.selectLabel}
        ...
        <FormControl>
          <InputLabel className={classes.menuLabel} htmlFor="Microphone">Microphone</InputLabel>
          <Select className={classes.selectLabel}
