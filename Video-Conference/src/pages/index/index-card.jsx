...
export default function IndexCard () {
  ...
  const handleClick = () => {
    if (!stateCtx.config.channelName) {
      mutationCtx.toastError('Channel Name Not Found')
      return
    }
    ...
    >
      ...
      >
        ...
        <FormControl className={clsx(classes.input, classes.grid)}>
          <InputLabel className={classes.labelColor} htmlFor="channelName">Channel name</InputLabel>
          <Input className={classes.labelInput} defaultValue="JobMatchMakingPortal" autoFocus='true' placeholder="JobMatchMakingPortal" 
           
           id="channelName"
           name="channelName"
            
           autoComplete="JobMatchMakingPortal"
    
           value={stateCtx.config.channelName}
           //value="JobMatchMakingPortal"
            ...
            onChange={(evt) => {
              ...
              // }
               mutationCtx.updateConfig({ channelName: "JobMatchMakingPortal"})
            }}  
          />
        </FormControl>
        <Box
