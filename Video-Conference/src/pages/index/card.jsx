...
import avt from '../../assets/vdCallNoBg.png'
const useStyles = makeStyles(theme => ({
  ...
  coverRight: {
    background: 'linear-gradient(to bottom, black, 50%, black)',
    position: 'relative',
    flex: 1,
    display: 'flex'
  },
          ...
          <div className={classes.coverLeft}>
            ...
            <div className={classes.item}>
              <div className={classes.coverContent}>
                ...
                <Box textAlign="center" fontWeight="fontWeightRegular" fontSize="h4.fontSize" className={classes.midItem}>Video</Box>
                <Box textAlign="center" fontWeight="fontWeightRegular" fontSize="h4.fontSize" className={classes.midItemNext}>Conferencing</Box>
                ...
                <Box textAlign="center" fontWeight="fontWeightRegular" className={classes.fontStyle} fontSize="h7.fontSize">Powered by Job Matching Portal</Box>
              </div>
            </div>
          </div>
